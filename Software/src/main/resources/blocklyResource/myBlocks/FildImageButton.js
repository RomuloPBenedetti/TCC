 ...
 * @constructor
 */
Blockly.FieldImageButton= function(src, width, height, opt_alt, eventFunction) {
  ...
  this.text_ = opt_alt || '';
  this.event_ = eventFunction;
  this.setValue(src);
};
goog.inherits(Blockly.FieldImageButton, Blockly.Field);
...
Blockly.FieldImageButton.prototype.init = function() {
  ...
  topElement.addEventListener("click", this.event_.bind(this));
};
