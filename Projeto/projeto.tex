...
A automatização por via de uma abordagem mais visual destes modelos permitiria a obtenção das vantagens aqui discutidas, sem deslocar o utilizador de sua área de domínio, a interface gráfica. 
	...
	Tornar possível a automação de tarefas em interfaces gráficas por meio da simplificação de uma abordagem visual com base na biblioteca de programação Visual Blockly dentro do contexto de modelos de simulação de cultivares agrícolas.
	...
	\begin{itemize}
		...
		\item Auxiliar o campo de pesquisa e trabalho com modelos matemáticos de cultivares agrícolas;
	\end{itemize}
...
Blockly.Blocks['text_length'] = {
  init: function() {
	...
	\subsection{Modelos matemáticos agrícolas}
	...
	\begin{enumerate}
		...
		Nesta etapa serão recolhidos requisitos suficientes para a proposta inicial do projeto de automatizar tarefas em modelos de simulação de cultivares agrícolas, mais especificamente nos simuladores definidos, seguindo para a especificação da abordagem de desenvolvimento do programa e de uma linguagem visual adequada ao projeto com base nas ferramentas definidas e requisitos coletados.
		...
		Avaliação da competência do software em automatizar os modelos de simulação de cultivares agrícolas sugeridos, em uso no centro de Fitotecnia da Universidade Federal de Santa Maria, avaliando a resistência do usuário a ferramenta, dependência de treinamento e efetividade na automatização das tarefas dos modelos.
	\end{enumerate}
