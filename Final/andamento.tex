...
\chapter{Introdução}
	...
	Assim como também reduz a necessidade de interação humana com tarefas secundárias ou de pouco interesse no desenvolvimento de software, contribuindo para redução da complexidade da tarefa.
	...
	{\centering \begin{tabular}{ | m{15.6cm} | }
		...
		{\bf UiPath:} \\ \\
		{\bf Prós:} Conseguiu fazer com que o software rodasse o SoySim para \emph{SingleYear} e  \emph{LongTermRun}. Uma rodada sozinha. \\ \\
...
% ultimas mudancas
    ...
    Com base nas informações obtidas dos casos de teste assim como discussão com os atores envolvidos foram elencadas diversas funcionalidades e, por fim, foram selecionados alguns requisitos funcionais mínimos para a solução dos problemas descritos nos casos de testes dos autores.

    \begin{enumerate}

		\item Deve ser possível executar, salvar ou carregar quebra-cabeças construídos pelo ator de forma que se possa reutilizar quebra-cabeças construídos anteriormente no programa.
		...
		\item Um bloco capaz de esperar por uma alteração na tela que indique que o programa pode prosseguir para as próximas tarefas definidas pelo autor.

       \item Um bloco capaz de digitar textos por meio da entrada do sistema, como se fosse um teclado.
